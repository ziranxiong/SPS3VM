classdef IncSemiSVM
    ...
    methods(Static = true)
        ...
        function out=Run(original_y,extended_x,extended_y,added_x,added_y,initial_solution)
            ...
            length_original=length(extended_y);
            steps=0;
            svm_struct=initial_solution;
%             path=initial_solution;
            while length(tmp_y)~=0
                extended_x=[extended_x;tmp_x(1,:)];
                extended_y=[extended_y;tmp_y(1);]; %%% the added sample is placed in the end line of matrix x
                ...
                g=IncSemiSVM.GetG(extended_x,extended_y,svm_struct);
                [svm_struct,index_A,direction_A]=IncSemiSVM.InitialA(svm_struct,g(end),length(extended_y),added_y);
            ...
            switch  index_class
                ...
                case 8
                    ...
                    if svm_struct.pms(index,1)<0
                        ...
                        svm_struct.pms(index,2)=C_star;
                        tmp1=C_star;
                    else
                        svm_struct.pms(index,1)=-C_star;
